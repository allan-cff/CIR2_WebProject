...
<body class="d-flex flex-column h-100 justify-content-between">
  ...
  <?php
    if(isset($_POST['new_lesson']) && isset($_POST['class_add_lesson']) && isset($_POST['semester_add_lesson']) && isset($_POST['teacher_add_lesson']) && isset($_POST['matter_add_lesson'])){
      try {
        $user->addLesson($_POST['matter_add_lesson'], $_POST['teacher_add_lesson'], $_POST['class_add_lesson'], $_POST['semester_add_lesson']);
        echo '
        <div class="container">
        ...
        <div class="container">
          <div class="alert alert-danger d-flex align-items-center alert-dismissible fade show" role="alert">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
              ...
              &nbsp;Erreur durant l\'ajout du cours
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
        </div>  
        ';
  ...
  <main>
    <div class="container">
      <div class="row">
        <form class="col-md-7 offset-md-3" method="post" action="admin_add_lesson.php">
          ...
          <div class="input-group mb-3">
            <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">Professeur</label>
              ...
              <select class="form-select" name="teacher_add_lesson">
                <?php
                  ...
                  foreach ($teachers as $teacher) {
                    echo '<option value="'.$teacher->mail.'">'.$teacher->getFullName().'</option>';
                  }
                ?>
              </select>
            </div>
          ...
          <input class="btn text-bg-danger mt-3 col-md-4 offset-md-3" type="submit" value="Ajouter" name="new_lesson">
        </form>
      </div>
    </div>
  </main>
