...
<body class="d-flex flex-column h-100 justify-content-between">
        ...
        <div class="container">
          <div class="alert alert-danger d-flex align-items-center alert-dismissible fade show" role="alert">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
              ...
              &nbsp;Erreur durant l\'ajout du campus !
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
        </div>  
        ';
  ...
  <div class="container">
      <div class="row">
        <form class="col-md-7 offset-md-3" method="post" action="admin_add_campus.php">
          <div class="mb-3 row">
            <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">Ville</label>
