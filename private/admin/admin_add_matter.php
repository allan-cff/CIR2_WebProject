...
<body class="d-flex flex-column h-100 justify-content-between">
  ...
  <?php
    if(isset($_POST['new_matter']) && isset($_POST['matter_name'])){
      try {
        $user->addMatter($_POST['matter_name']);
        echo '
        <div class="container">
        ...
        <div class="container">
          <div class="alert alert-danger d-flex align-items-center alert-dismissible fade show" role="alert">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
              ...
              &nbsp;Erreur durant l\'ajout de la matière
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
        </div>  
        ';
  ...
  <main>
    <div class="container">
      <div class="row">
        <form class="col-md-7 offset-md-3" method="post" action="admin_add_matter.php">
          <div class="mb-3 row">
            <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">Nom de la matière</label>

            <div class="col-sm-8">
              <input type="text" class="form-control" placeholder="FHS" name="matter_name">
            </div>
          </div>

          <input class="btn text-bg-danger mt-3 col-md-4 offset-md-3" type="submit" value="Ajouter" name="new_matter">
        </form>
      </div>
    </div>
  </main>
