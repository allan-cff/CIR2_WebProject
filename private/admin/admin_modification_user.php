    ...
    <div class="container">
      <div class="row">
        <form class="col-md-7 offset-md-3" method="post" action="admin_add_user.php">
          ...
          <input class="btn border-danger text-danger mt-3 col-md-2 offset-md-2" type="submit" value="Modifier" name="modif_user">
          <input class="btn text-bg-danger mt-3 col-md-2 offset-md-2" type="submit" value="Supprimer" name="delete_user">
        </form>
      </div>
    </div>
  </main>
