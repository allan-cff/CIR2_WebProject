...
<body class="d-flex flex-column h-100 justify-content-between">
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link" href="admin_add_campus.php">
                  Ajout campus
              ...
              <li class="nav-item">
                <a class="nav-link" href="admin_add_cycle.php">
                  Ajout cycle
  ...
  <?php
    if(isset($_POST['add_semester']) && isset($_POST['date_begin_add_semester']) && isset($_POST['date_end_semester']) && isset($_POST['name_add_semester'])){
      try {
        $user->addSemester($_POST['date_begin_add_semester'], $_POST['date_end_semester'], $_POST['name_add_semester']);
        echo '
        <div class="container">
        ...
        <div class="container">
          <div class="alert alert-danger d-flex align-items-center alert-dismissible fade show" role="alert">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
              ...
              &nbsp;Erreur durant l\'ajout du semestre
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
        </div>  
        ';
  ...
  <main>
    <div class="container">
      <div class="row">
        <form class="col-md-7 offset-md-3" method="post" action="admin_add_semester.php">
          <div class="mb-3 row">
            <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">Intitulé du semestre</label>
            <div class="col-sm-8">
              <input type="text" class="form-control" name="name_add_semester">
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-8">
              <input id="date_begin_add_semester" name="date_begin_add_semester"/>
              <script>
                $('#date_begin_add_semester').datepicker({
                  footer: true, 
                  modal: true,
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-8">
              <input id="date_end_semester" name="date_end_semester"/>
              <script>
                $('#date_end_semester').datepicker({
                  footer: true, 
                  modal: true,
                  uiLibrary: 'bootstrap5'
                });
          ...
          <input class="btn text-bg-danger mt-3 col-md-4 offset-md-3" type="submit" value="Ajouter" name="add_semester">
        </form>
      </div>
    </div>
  </main>
